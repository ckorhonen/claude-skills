...
| [ascii-pixel-art](./skills/ascii-pixel-art) | Transform images into animated ASCII art with subject detection, blurred backgrounds, and cinematic effects (pulse, shine, flicker, hover) | Converting portraits to animated ASCII art; generating retro/cyberpunk visualizations; creating interactive web art pieces; artistic image transformations with dynamic lighting |
