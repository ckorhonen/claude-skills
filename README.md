...
| [babysit-pr](./skills/babysit-pr) | Monitor a GitHub pull request continuously for CI checks, review comments, flaky reruns, and mergeability until it is merge-safe or needs intervention | Watching PR CI after pushing changes; triaging flaky reruns vs real failures; handling review feedback quickly; keeping one PR in active merge-ready babysitting mode |
